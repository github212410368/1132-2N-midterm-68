'use client';
import { tours_68 } from '@/components/mid1_68/p2_68/tours_data_68';
import Wrapper from '@/styles/wrappers/mid1_68/Tours';

export default function Mid1P2Page_68() {
  console.log('p2_68: tours_68', tours_68);
  return (
    <Wrapper>
      <div className='title text-emerald-700'>
        <h2 className='text-2xl'> p2_68:Our Tours(json arrays) </h2>
